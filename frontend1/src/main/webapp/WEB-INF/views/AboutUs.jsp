                    ...
                    <div class="row">
						<div class="col-md-7 col-sm-6">
							<div class="about-title clearfix">
								<h1>About <span>ESHOP</span></h1>
								<h3>Amazing Online Shopping </h3>
								<p class="about-paddingB">ESHOP is known as the go-to online retailer for almost anything, from books, toys, clothes and shoes to electronics, furniture and other household items. For a recurring fee, its Prime membership offers free two-day shipping on most purchases.The eshop website gets an average of about 1.87 billion visits per month. </p>
								<p> Rather than identifying as an online store, the company sees itself as an online platform that connects sellers and consumers.</p>
								<p>Our aim is to render quality and prompt services to all our customers and make their shopping experience satisfying.</p>
